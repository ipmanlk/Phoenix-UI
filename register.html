...
<html lang="en">
  ...
  <div class="container margintop" >
    <br>
   <center> <h2 class="txtwhite"> Register </h2></center>
   <div class="card cardpadding" >

<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="txtFname" name="txtFname">First Name</span>
  </div>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="txtLname" name="txtLname">Last Name</span>
  </div>
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
</div>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="txtCPassword" name="txtCPassword">Confirm Password</span>
  </div>
  <input type="password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
</div>
